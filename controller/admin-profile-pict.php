...
if ($_SERVER['REQUEST_METHOD'] === 'POST' && isset($_FILES['profile_picture'])) {
    ...
    if (empty($errorMessage) && move_uploaded_file($_FILES["profile_picture"]["tmp_name"], $targetFilePath)) {
        ...
        $logData = "Admin $usernameAdmin updated profile."; // Customize as needed
            ...
            <div class="col-md-6 d-flex flex-column">
                <?php if (!empty($successMessage)) : ?>
                    ...
                    <div class="m-auto mt-5">
                        <p>You will be redirected to the dashboard in 3 seconds. If not, click <a href="/crms-project/admin-dashboard">here</a>.</p>
                    </div>
                    <meta http-equiv="refresh" content="3;url=/crms-project/admin-dashboard">
                <?php endif; ?>
